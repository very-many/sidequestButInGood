...
namespace Sidequst {
    TEST_F(RestTest, QUEST_FETCH_BY_PARENT_1) {
        auto parent_quest = new SerialisableQuest("Parent Quest", "", Quest::initial, nullptr, nullptr, nullptr);
        auto parent_quest_id = client->stubs()->create_quest(parent_quest);

        auto sub_quest = new SerialisableQuest("Sub Quest", "", Quest::initial, parent_quest, nullptr, nullptr);
