...
namespace Sidequst {
    TEST_F(RestTest, QUEST_CREATE_THEN_DELETE) {
        auto quest = new SerialisableQuest("REST Test Quest", "", Quest::initial, nullptr, nullptr, nullptr);
    ...
    TEST_F(RestTest, QUEST_CREATE_THEN_READ) {
        auto quest1 = new SerialisableQuest("REST Test Quest", "", Quest::initial, nullptr, nullptr, nullptr);
